...
class CentroAcopioExport implements FromView, WithColumnWidths, WithStyles, WithDrawings, WithBackgroundColor
{
    ...
    public function view(): View
    {
        ...
        return view('exports.ExcelCentrosAcopio', compact('centros'));
    }
}
